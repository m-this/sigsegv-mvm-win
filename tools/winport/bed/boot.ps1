...
if ($srcds -and (Test-Path $cdb)) {
  ...
  @(
    ...
    'sxe -c ".echo FIRST-CHANCE AV; r; kv 16; .echo FAULT-CODE; u @eip-10 L8; .echo STACK-WORDS; dps @esp L16; .echo ECX-WORDS; dd @ecx L12; .echo ECX-TEXT; da @ecx L40; .echo FRAME-PARAMS; kP 12; gn" -c2 ".echo SECOND-CHANCE AV; r; kv 60; lm; .dump /ma C:/bed/dumps/av.dmp; q" av'
